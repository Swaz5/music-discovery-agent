...
# Hard timeout for every Deezer API call.  Without this a single slow/hung
# response blocks the entire FastAPI asyncio event loop.
_TIMEOUT = httpx.Timeout(10.0)
# Preview downloads are larger files (~500 KB) so they get more time.
